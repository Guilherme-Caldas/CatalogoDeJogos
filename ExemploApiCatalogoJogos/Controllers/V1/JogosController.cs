...
namespace ExemploApiCatalogoJogos.Controllers.V1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        /// <summary>
        /// Buscar uma lista de jogos pelo nome
        /// </summary>
        /// <param name="nome">Nome do jogo buscado</param>
        /// <response code="200">Retorna o jogo filtrado</response>
        /// <response code="204">Caso não haja jogo com este nome</response>

        [HttpGet("nome/{nome}")]
        public async Task<ActionResult<JogoViewModel>> ObterNome([FromRoute] string nome)
        {
            var jogo = await _jogoService.ObterNome(nome);
